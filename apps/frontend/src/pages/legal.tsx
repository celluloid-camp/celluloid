  ...
  >
    ...
    <Typography component="div">
      <p>
        ...
        exploité par l'Institut Catholique de Paris, ("ICP"), vous acceptez les
        termes des Règles de confidentialité en ligne présentées ci-après. Si
        vous n'êtes pas d'accord avec ces termes, veuillez ne plus utiliser ou
        accéder à ce site.
      </p>
      <p>
        <b>Editeur :</b>
      ...
      <p>
        L’Institut Catholique de Paris ne saurait être tenu pour responsable des
      ...
      <p>
        ...
        Paris ne sera responsable des préjudices fortuits, directs ou indirects
        résultant de l'utilisation des éléments du Site.
      </p>
      <p>
      ...
      <p>
        <b>Réalisation et hébergement :</b> Erwan Quéffelec, Souleymane Thiam et
        Guillaume Aichhorn
      </p>
      <p>
        Celluloid est un projet open source, partagé ici :{" "}
        <a href="https://github.com/celluloid-edu">github.com/celluloid-edu</a>.
        Les contenus du site internet Celluloid ainsi que leur structuration en
        catégories et thématiques font l’objet d’une licence{" "}
    ...
    <Typography component="div">
      ...
      <p>
        ...
        acceptez le fait que Celluloid peut avoir besoin, pour la réalisation de
        l'opération et la mise à jour des fichiers associés, de transférer,
        stocker et traiter ces informations.
      </p>
      <p>
        Celluloid recueille ces informations afin d'enregistrer et de prendre en
        compte votre participation dans les activités que vous avez choisies. Si
        vous demandez une documentation, par exemple, ces informations sont
        utilisées pour enregistrer vos coordonnées afin de pouvoir vous
        l'envoyer.
      </p>
      <p>
    ...
    <Typography component="div">
      <p>
        ...
        faire, envoyez un courrier à l'Institut Catholique de Paris à l'adresse
        suivante :
      </p>
      <p>
    ...
    <Typography component="div">
      <p>
        ...
        vous-même fourni à l'Institut Catholique de Paris des informations
        personnelles.
      </p>
      <p>
        Un cookie est un petit volume de données qui est transféré à votre
        navigateur par un serveur Web et qui ne peut être lu que par le serveur
        qui vous l'a envoyé. Il fonctionne comme une carte d'identité, en
        enregistrant vos mots de passe, et préférences. Il ne s'agit pas d'un
        code exécutable et il ne peut pas transmettre de virus. Les informations
        stockées dans ce cookie sont cryptées de manière à éviter un usage de
        votre ordinateur à votre insu. Celluloid utilise un cookie technique qui
        ne collecte pas les données de navigation. Les cookies associés aux
        vidéos visionnées dans le cadre de Celluloid sont bloqués.
      </p>
      <p>
    ...
    <Typography component="div">
      <p>
        ...
        Celluloid associent un créateur de projet (qui peut par exemple être un
        enseignant) et des participants à ce projet (qui peuvent par exemple
        être ses élèves). Dans tous les cas, l’utilisateur qui crée un projet
        dans Celluloid et y associe une vidéo lue depuis un site tiers
        (PeerTube) est responsable du projet et de l’usage de la vidéo qui y est
        faite :
      </p>
      <p>
        ...
        et la vidéo supprimés, par Celluloid et/ou par l’hébergeur de la vidéo.
      </p>
      <p>
        ...
        commentaires laissés par les participants et supprimer, le cas échéant,
        ceux qui porteraient atteinte au droit. Dans le cas contraire, et
        notamment en cas de plainte d’un participant, Celluloid se réserve le
        droit de supprimer le projet, sans préavis et sans possibilité de
        recours du créateur du projet ni de ses participants.
      </p>
      <p>
        Les vidéos utilisées dans le cadre des projets créés dans Celluloid sont
        hébergé par des sites tiers (PeerTube notamment). Le contenu de ces
        vidéos ne sauraient engager la responsabilité des responsables
