...
export default () => (
  ...
  >
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      ...
      <p>
        <b>Communauté :</b> désigne le groupe dans lequel Vous contribuez pour réaliser le
        Projet.
      </p>
    </Typography>
    <Typography variant="h4" gutterBottom={true}>
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      <p>
        ...
        informations et Contenus placés sur la Plateforme.
      </p>
      <p>
      ...
      <p>
        Les CGU
        peuvent être complétées, le cas échéant, par des conditions d’utilisation
        particulières à certains Projets Partenaires. En cas de contradiction, les
        conditions particulières instaurées lors de ces Projets Partenaires par les
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      <p>
        ...
        s’engager au titre des CGU. La personne physique qui ne dispose pas de la pleine
        capacité juridique ne peut accéder au Site et aux Services qu’avec l’accord de
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      <p>
        ...
        adhésion sous réserve est considérée comme nulle et non avenue. La Plateforme ne
        vous sera accessible qu’uniquement dans l’hypothèse de votre acceptation des
        CGU.
      </p>
      <p>
        L’utilisation de la Plateforme nécessite Votre inscription dans le formulaire
        prévu à cet effet. Ce formulaire est disponible sur la Plateforme. Vous êtes
        prié(e) de fournir toutes les informations requises comme obligatoires. Toute
        inscription incomplète ne sera pas validée. Suite à cette inscription, Votre
        compte utilisateur sera créé, vous permettant d’accéder à un espace personnel.
      </p>
      <p>
        Vous garantissez que toutes les informations inscrites dans le formulaire,
        mentionné ci-dessus, sont exactes, à jour et sincères et ne sont entachées
        d’aucun caractère trompeur. Dans la mesure du possible, vous vous engagez à
        mettre à jour ces informations depuis votre espace personnel, afin que ces
        informations soient toujours à jour.
      </p>
      <p>
        Vous êtes explicitement informé(e) et Vous acceptez que les informations saisies
        aux fins de création ou de mise à jour de Votre compte utilisateur vaillent
        preuve de Votre identité. Les informations saisies par l’utilisateur l’engagent
        dès leur validation.
      </p>
      <p>
        Après identification grâce à votre identifiant de connexion combiné avec votre
        mot de passe, Vous pouvez accéder à tout moment à Votre espace personnel.
      </p>
      <p>
        Vous vous engagez à utiliser personnellement la Plateforme et à ne permettre à
        aucun tiers de les utiliser à Votre place ou pour Votre compte, sauf à en
        supporter l’entière responsabilité d’une utilisation illicite ou contraire aux
        CGU.
      </p>
      <p>
        Vous êtes totalement responsable du maintien de la confidentialité de Votre
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      ...
      <ul>
        <li>
          à respecter les lois et règlements en vigueur et à ne pas porter atteinte aux
          droits de tiers ou à l’ordre public
        </li>
        <li>
          à avoir pris connaissance sur la Plateforme des caractéristiques et
          contraintes, notamment techniques, de l’ensemble des fonctionnalités. Vous
          êtes seul(e) responsable de Votre utilisation.
        </li>
        <li>
          d’être informé(e) et d’accepter que la mise en œuvre de la Plateforme
          nécessite la connexion à internet et que la qualité de la Plateforme dépend
          directement de cette connexion, dont Vous êtes seul(e) responsable.
        </li>
        <li>
          d’être seul(e) responsable des relations nouées avec les utilisateurs tiers de
          la Plateforme et des informations communiquées sur la Plateforme. Vous devez
          exercer une prudence et un discernement appropriés dans ces relations et
          communications. De surcroît, Vous vous engagez à respecter les règles usuelles
          de politesse et de courtoisie telle que définie ci-dessous.
        </li>
        <li>
          à ne faire qu’un usage strictement personnel de la Plateforme. Ainsi Vous vous
          interdisez en conséquence de céder, concéder ou transférer tout ou partie de
          Vos droits ou obligations au titre des CGU à un tiers, de quelque manière que ce
          soit.
        </li>
        <li>
        ...
        <li>
          à être seul(e) responsable des Contenus de toute nature (rédactionnels,
          graphiques, audiovisuels ou autres, en ce compris la dénomination et/ou
          l’image éventuellement choisies par l’Utilisateur pour l’identifier sur le site)
        ...
        <li>
          à ce que les Contenus soient licites, ne portent pas atteinte à l’ordre
      ...
      <p>
        Sans que cette liste soit exhaustive, Vous vous engagez à ne pas diffuser :
      </p>
      <ul>
        <li>
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      ...
      <p>
        Il est strictement interdit de monnayer, vendre ou concéder tout ou partie de
        l’accès aux Services ou au site, ainsi qu’aux informations qui y sont hébergées
        et/ou partagées.
      </p>
    </Typography>
    <Typography variant="h4" gutterBottom={true}>
    ...
    <Typography component="div" style={{ textAlign: 'justify' }}>
      ...
      <p>
        ...
        propres contraintes personnelles, répondront spécifiquement à vos besoins et
        attentes.
      </p>
      <p>
