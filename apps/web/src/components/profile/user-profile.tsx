...
function ProfileSkeleton() {
  return (
    <Stack alignItems="center" spacing={2}>
      ...
      <Skeleton variant="text" width={200} height={40} /> {/* username */}
      <Skeleton variant="text" width={250} height={24} /> {/* email */}
      <Skeleton variant="text" width={150} height={24} /> {/* role */}
      <Skeleton variant="text" width={300} height={60} /> {/* bio */}
    </Stack>
  );
}
