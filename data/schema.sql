...
INSERT INTO  public."Tag" VALUES
  (gen_random_uuid(), 'Français - Lettres', true),
  (gen_random_uuid(), 'Mathématiques', true),
  (gen_random_uuid(), 'Histoire', true),
  (gen_random_uuid(), 'Géographie', true),
  (gen_random_uuid(), 'Technologie', true),
  (gen_random_uuid(), 'Ëducation civique', true),
