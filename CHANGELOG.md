...
- **README**: Add Erwan Queffelec as initial tech contributor &nbsp;-&nbsp; by **Erwan Queffélec** in https://github.com/celluloid-camp/celluloid/issues/324 [<samp>(a30ac)</samp>](https://github.com/celluloid-camp/celluloid/commit/a30ac95)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/celluloid-camp/celluloid/compare/v3.3.0-alpha.1...staging)
